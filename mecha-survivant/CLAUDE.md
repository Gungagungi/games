...
8. **Boss multi-phases** — `MEGA_PHASE_HP` / `TITAN_PHASE_HP` : la barre est **remise à plein à chaque phase** via `megaAdvancePhase` / `titanAdvancePhase`, qui montent aussi les multiplicateurs de vitesse et de dégâts.
